...
if not os.path.exists("dataset_words"):
    ...
    print("OK Created dataset_words directory")
...
print("\n" + "="*70)
print(f"OK Data Collection Complete! ({counter} total images collected)")
print("="*70 + "\n")
