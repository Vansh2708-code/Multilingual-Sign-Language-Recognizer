...
for idx, word in enumerate(WORDS):
    ...
    print(f" ✅ ({len([x for i, x in enumerate(X) if y[i] == idx])} total)")

if len(X) == 0:
    print("❌ No images found! Check dataset_words/ folder")
    exit(1)
...
print("\n✅ Model saved to model_words/keras_model.h5")
...
print("✅ Labels saved to model_words/labels.txt")

print("\n" + "="*70)
print("✨ TRAINING SUCCESS!")
print("="*70)
print("\nNext steps:")
print("1. Run data_collection_words.py to collect more data if needed")
print("2. Run main_words.py to test the model")
print("3. Update Multilingual_recognizer_with_numerals.py to add Words mode\n")
