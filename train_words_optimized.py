...
for idx, word in enumerate(WORDS):
    ...
    print(f"Loading {word}: {len(images)} images...", end="", flush=True)
...
print("="*70)
print("\nNext steps:")
print("1. python main_words.py              (Test the model)")
print("2. python Multilingual_recognizer_with_numerals.py  (Use in app)\n")
